...
(function() {
  var BaseConfig, FrontendConfig, autoprefixer, defaults, fs, isArray, merge, mergeWith, postcssFilenamePrefix, union, url, webpack,
  ...
  module.exports = FrontendConfig = (function(superClass) {
    ...
    function FrontendConfig() {
      ...
      if ((((ref = this.options.frontend) != null ? ref.loaders : void 0) != null) && isArray(this.options.frontend.loaders)) {
        this.config.module.loaders = this.options.frontend.loaders.concat(this.config.module.loaders);
      }
      if ((((ref1 = this.options.frontend) != null ? ref1.preLoaders : void 0) != null) && isArray(this.options.frontend.preLoaders)) {
        this.config.module.preLoaders = this.options.frontend.preLoaders.concat(this.config.module.preLoaders || []);
      }
      if ((((ref2 = this.options.frontend) != null ? ref2.postLoaders : void 0) != null) && isArray(this.options.frontend.postLoaders)) {
    ...
    FrontendConfig.prototype._getBeforeStylusEntries = function() {
      ...
      for (appName in ref) {
        entry = ref[appName];
        entry = isArray(entry) ? entry[0] : entry;
    ...
    FrontendConfig.prototype._getStylusParams = function() {
      ...
      return merge({}, this.options.stylus, DEFAULT_STYLUS);
    };

    FrontendConfig.prototype._getActualStylusLoader = function(params, override) {
      var strStylusParams, stylusParams;
      if (params == null) {
        params = {};
      }
      stylusParams = this._getStylusParams();
      if (override) {
        params = Object.assign({}, stylusParams, params);
      } else {
        params = mergeWith(Object.assign({}, stylusParams), params, function(objValue, srcValue) {
          if (isArray(objValue)) {
