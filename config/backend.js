...
(function() {
  var BackendConfig, BaseConfig, defaults, flatten, fs, isArray, webpack,
  ...
  module.exports = BackendConfig = (function(superClass) {
    ...
    function BackendConfig() {
      ...
      if ((((ref = this.options.backend) != null ? ref.loaders : void 0) != null) && isArray(this.options.backend.loaders)) {
        this.config.module.loaders = this.options.backend.loaders.concat(this.config.module.loaders);
      }
      if ((((ref1 = this.options.backend) != null ? ref1.preLoaders : void 0) != null) && isArray(this.options.backend.preLoaders)) {
        this.config.module.preLoaders = this.options.backend.preLoaders.concat(this.config.module.preLoaders || []);
      }
      if ((((ref2 = this.options.backend) != null ? ref2.postLoaders : void 0) != null) && isArray(this.options.backend.postLoaders)) {
